...
void readEquil(int n, int m, int v, int rmax, double *t, double *s){
	// error flags
	if (n != 10){
...
//	if (v != 92 && v != 615 && v != 836 && v != 65 && v != 70 && v != 75 && v!=80 && v != 85 && v != 90 && v != 95){
//		cout << "Error: support only for v = 65 to 95." << endl;
//		return;
//	}

//	if (rmax < 70 || rmax > 99){
//		cout << "Error: support only for 70 <= rmax <= 99." << endl;
//		return;
//	}
	...
	maxrad << fixed << rmax;
	capnum << 0;
	filename = "../input/pro_v" + redvol.str() + "_rmax" + maxrad.str()
	           + "_Ca" + capnum.str() + ".dat";
